/**
 * ARCHIVO: script.js
 * SISTEMA: Sistema de conquista internacional
 * DESCRIPCIÓN: Versión unificada con textos extensos, Kuromi, negritas fijas y alertas de error originales.
 */
...
// Kuromi ASCII simétrica y estable
const kuromiArt = `
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⣀⣀⣀⣀⢠⠋⠉⠉⠒⠲⢤⣀⣠⡀⠀
⠀⠀⠀⠀⠀⠀⣀⣀⣀⢀⡠⠖⠋⠉⠀⠀⠀⠀⠉⠉⠢⣄⠀⠀⠀⢀⠼⠤⠇⠀
⠀⠀⠀⣀⠔⠊⠁⠀⢨⠏⠀⠀⠀⣠⣶⣶⣦⠀⠀⠀⠀⠀⠱⣄⡴⠃⠀⠀⠀⠀
...
function runCommand(tipo) {
    ...
    function typeWriter() {
        if (i < text.length) {
            // Captura las etiquetas HTML (como <div> y <b>) de una vez para que no aparezca código roto en la escritura
            if (text.charAt(i) === '<') {
